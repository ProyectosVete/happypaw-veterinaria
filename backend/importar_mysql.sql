-- Base de datos para Sistema Veterinario
...
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (1, '2', 'Mina_Park - Veterinario', 1, '[{"added": {}}]', 6, 1, '2026-03-17 19:33:04.877912');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (2, '2', 'Mina_Park - Veterinario', 2, '[{"changed": {"fields": ["First name", "Last name", "Email address"]}}]', 6, 1, '2026-03-17 19:34:04.804014');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (3, '1', 'admin1 - Administrador', 2, '[{"changed": {"fields": ["Role"]}}]', 6, 1, '2026-03-17 19:34:43.068952');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (4, '3', 'veterinario1 - Veterinario', 1, '[{"added": {}}]', 6, 1, '2026-03-20 17:14:36.203446');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (5, '4', 'adminp - Administrador', 1, '[{"added": {}}]', 6, 1, '2026-03-20 17:15:09.131754');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (6, '3', 'veterinario1 - Veterinario', 2, '[{"changed": {"fields": ["First name", "Last name", "Email address", "Staff status", "Superuser status", "User permissions"]}}]', 6, 1, '2026-03-20 17:20:07.037188');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (7, '1', 'admin1 - Administrador', 2, '[{"changed": {"fields": ["User permissions"]}}]', 6, 1, '2026-03-20 17:20:53.740791');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (8, '2', 'Mina_Park - Veterinario', 3, '', 6, 1, '2026-03-20 17:48:49.325550');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (9, '4', 'adminp - Administrador', 3, '', 6, 1, '2026-03-20 17:48:49.325666');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (10, '3', 'veterinario1 - Veterinario', 3, '', 6, 1, '2026-03-20 17:48:49.325753');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (11, '5', 'Carlos - Veterinario', 1, '[{"added": {}}]', 6, 1, '2026-03-20 17:49:43.789802');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (12, '5', 'Carlos - Veterinario', 2, '[{"changed": {"fields": ["First name", "Last name", "Email address"]}}]', 6, 1, '2026-03-20 17:50:42.738268');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (13, '7', 'jessi - Veterinario', 1, '[{"added": {}}]', 6, 1, '2026-03-25 22:11:24.140275');
INSERT INTO `django_admin_log` (`id`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`, `action_time`) VALUES (14, '7', 'jessi - Veterinario', 2, '[{"changed": {"fields": ["First name", "Last name", "Email address", "Staff status", "Superuser status", "User permissions"]}}]', 6, 1, '2026-03-25 22:11:59.269913');
...
CREATE TABLE `users_groups` (`id` integer NOT NULL PRIMARY KEY AUTO_INCREMENT, `user_id` bigint NOT NULL REFERENCES `users` (`id`) DEFERRABLE INITIALLY DEFERRED, `group_id` integer NOT NULL REFERENCES `auth_group` (`id`) DEFERRABLE INITIALLY DEFERRED);

-- Crear tabla: users_user_permissions
DROP TABLE IF EXISTS `users_user_permissions`;
CREATE TABLE `users_user_permissions` (`id` integer NOT NULL PRIMARY KEY AUTO_INCREMENT, `user_id` bigint NOT NULL REFERENCES `users` (`id`) DEFERRABLE INITIALLY DEFERRED, `permission_id` integer NOT NULL REFERENCES `auth_permission` (`id`) DEFERRABLE INITIALLY DEFERRED);
